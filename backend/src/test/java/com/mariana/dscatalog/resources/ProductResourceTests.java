...
public class ProductResourceTests {
	...
	void setUp() throws Exception {
		...
		doThrow(ResouceNotFoundException.class).when(service).delete(nonExistingId);
		doThrow(DatabaseException.class).when(service).delete(dependentId);
	}
	
	@Test
	public void deletetShowldReturnProductDTOCreated() throws Exception {
	...
	@Test
	public void deletetShowldReturnNotFoundWhenIdDoesNotExists() throws Exception {
	...
	@Test
	public void insertShowldReturnProductDTOCreated() throws Exception {
